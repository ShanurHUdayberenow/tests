                                    ...
                                    <div class="box-content">
                                        <div class="range-slider-wrapper mt-3">
                                            ...
                                            <div id="input-slider-range"
                                                data-range-value-min="@if(count(\App\Models\Product::query()->get()) < 1) 0 @else {{ (\App\Models\Product::query())->get()->min('price') }} @endif"
                                                data-range-value-max="@if(count(\App\Models\Product::query()->get()) < 1) 0 @else {{ (\App\Models\Product::query())->get()->max('price') }} @endif">
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <span class="range-slider-value value-low" @if (isset($min_price))
                                                        ...
                                                        @elseif($products->min('price') > 0)
                                                        data-range-value-low="{{ $products->min('price') }}"
                                                        @else
                                                ...
                                                <div class="col-6 text-right">
                                                    <span class="range-slider-value value-high" @if (isset($max_price))
                                                        ...
                                                        @elseif($products->max('price') > 0)
                                                        data-range-value-high="{{ $products->max('price') }}"
                                                        @else
